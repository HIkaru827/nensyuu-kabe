            ...
            <CardContent className="space-y-8 pt-6">
              <section className="space-y-3">
                ...
                <p className="text-sm leading-relaxed text-muted-foreground">
                  子どもの年収が136万円を超える話では、本人の所得税と、親の扶養控除の話が混ざりやすいです。
                  本人の所得税は178万円を基準に見ることが多い一方で、親の扶養控除は136万円が目安です。
                </p>
                <p className="text-sm leading-relaxed text-muted-foreground">
                  そのため、136万円を超えたら直ちに「本人の手取りが大きく減る」と理解するとズレが出ます。
              ...
              <section className="space-y-3">
                ...
                <p className="text-sm leading-relaxed text-muted-foreground">
                  令和8年分以後の一般の扶養控除では、子どもの合計所得金額が62万円を超えると、親は扶養控除を受けにくくなります。
                  給与収入だけなら、136万円を超えるとそのラインを上回るため、親の所得税や住民税が増える可能性があります。
                </p>
                <p className="text-sm leading-relaxed text-muted-foreground">
                  この年齢帯では、136万円を少し超えた段階から親への影響が出やすいので、シフトを増やす前に家族で共有しておくと誤解が起こりにくくなります。
                </p>
              </section>
              ...
              <section className="space-y-3">
                ...
                <div className="space-y-3">
                  <div className="rounded-lg border border-border p-4">
                    <h3 className="text-base font-bold text-foreground">ケース1: 高校生が136万円を少し超える</h3>
                  ...
                  <div className="rounded-lg border border-border p-4">
                    <h3 className="text-base font-bold text-foreground">ケース3: 22歳で190万円近くまで働く</h3>
                    <p className="mt-2 text-sm leading-relaxed text-muted-foreground">
                  ...
                  >
                    <div className="flex items-start justify-between gap-3">
                      <div>
                        ...
                        <p className="text-xs text-muted-foreground">19歳以上23歳未満の段階控除と197万円の上限を確認できます。</p>
                      </div>
                      <ExternalLink className="h-4 w-4 shrink-0 text-muted-foreground" />
                    </div>
                  </a>
