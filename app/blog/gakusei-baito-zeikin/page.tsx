          ...
          <Card className="border-slate-200 bg-slate-50">
            <CardContent className="space-y-3 pt-6">
              ...
              <ul className="space-y-2 text-sm text-slate-700">
                <li>令和8年分以後、学生本人の所得税は給与収入178万円までなら発生しない設計です。</li>
                <li>親の扶養控除は、原則として給与収入136万円までが目安です。</li>
                <li>19歳以上23歳未満は、給与収入197万円まで特定親族特別控除の対象になり得ます。</li>
          ...
          <Card>
            <CardContent className="space-y-8 pt-6">
              <section className="space-y-3">
                <h2 className="text-2xl font-bold text-foreground">学生本人の所得税は178万円を基準に確認する</h2>
                <p className="text-sm leading-relaxed text-muted-foreground">
                  令和8年分以後の所得税では、令和8・9年分の給与所得控除の最低保障が74万円になり、
                  低所得帯の基礎控除104万円と合わせると、給与収入178万円までは所得税が発生しない設計です。
                  ここは学生かどうかにかかわらず、まず本人の税金を見る基準になります。
                </p>
              </section>

              <section className="space-y-3">
                <h2 className="text-2xl font-bold text-foreground">親の扶養控除は136万円が基本</h2>
                <p className="text-sm leading-relaxed text-muted-foreground">
                  親の税金で扶養控除の対象になるかを見るときは、子の合計所得金額が62万円以下かどうかを見ます。
                  給与収入だけなら、給与所得控除74万円を差し引いた後の所得で判定するため、給与収入136万円がひとつの目安です。
                </p>
              </section>
              ...
              <section className="space-y-3">
                ...
                <div className="rounded-lg border border-border bg-muted/40 p-4 text-sm text-muted-foreground">
                  <ol className="space-y-2">
                    <li>1. 本人の所得税を見るなら、まず178万円を確認する。</li>
                    <li>2. 親の扶養控除を見るなら、まず136万円を確認する。</li>
                    <li>3. 19歳以上23歳未満なら、197万円までの特定親族特別控除を追加で確認する。</li>
              ...
              <section className="space-y-3">
                ...
                <div className="space-y-3">
                  ...
                  >
                    <div className="flex items-start justify-between gap-3">
                      <div>
                        ...
                        <p className="text-xs text-muted-foreground">基礎控除、給与所得控除、扶養親族等の所得要件改正を確認できます。</p>
                      </div>
                  ...
                  >
                    <div className="flex items-start justify-between gap-3">
                      <div>
                        ...
                        <p className="text-xs text-muted-foreground">令和8・9年分の178万円、136万円、197万円の根拠を確認できます。</p>
                      </div>
                      <ExternalLink className="h-4 w-4 shrink-0 text-muted-foreground" />
                    </div>
                  </a>
                  ...
                  >
                    <div className="flex items-start justify-between gap-3">
                      <div>
                        <p className="text-sm font-semibold text-foreground">日本年金機構 短時間労働者の適用要件</p>
                        <p className="text-xs text-muted-foreground">週20時間、月額賃金、学生区分などの確認に使えます。</p>
                      </div>
                      <ExternalLink className="h-4 w-4 shrink-0 text-muted-foreground" />
                    </div>
                  </a>
